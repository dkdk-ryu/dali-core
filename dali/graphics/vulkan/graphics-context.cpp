...
GraphicsSwapchain GraphicsContext::CreateSwapchain(const GraphicsSurface& surface,
                                                   uint32_t               bufferCount,
                                                   DepthStencil           depthStencilMode,
                                                   bool                   enforceVSync)
{
  return GetObject()->CreateSwapchain( surface, bufferCount, depthStencilMode, enforceVSync );
}
